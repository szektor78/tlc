...
//Global options
var path_to_folder = '/facebook-profile-avatar-creator/',//the path to main SVG Avatars folder from root dir of your site. The slashes "/" are important!
...
var	hide_share = false, //true will disable share option
	...
	share_credit = 'Created on TimelineCovers.pro';//replase YourSite.com with yours or leave it blank (do NOT delete variable itself!), if you don't want a watermark on avatar for Social share
...
svg_msg,'</li><li id="svga-png-two">',png_two_msg,'</li><li id="svga-png-one">',png_one_msg,'</li></ul></li></ul></div></div></div></div><p class="svga-credit"><a href="https://timelinecovers.pro">← TimelineCovers.pro</a></p><div id="svga-start-overlay">&nbsp;</div><div id="svga-work-overlay">&nbsp;</div><div id="svga-loader">',wait_msg,'</div><div id="svga-gender">',welcome_slogan,'<div id="svga-starticons-wrap"><div id="svga-start-boys"></div><div id="svga-start-girls"></div></div>',
