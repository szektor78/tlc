$(function() {
	...
	function helloMenus() {
		var x=0, day=d.getDay(), str='aside > a[href="/covers/hello-';
		menus(15,str+'january"]');
		menus(25,str+'february"]');
		menus(35,str+'march"]');
		menus(45,str+'april"]');
		menus(55,str+'may"]');
		menus(65,str+'june"]');
		menus(75,str+'july"]');
		menus(85,str+'august"]');
		menus(95,str+'september"]');
		menus(15,str+'october"]');
		menus(15,str+'november"]');
		menus(15,str+'december"]');
		if (day<10){
			menus(1,str+'january"]');
