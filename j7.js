$(function() {
	...
	var coversrc = [
		...
		{"title":"lion", "id":9},
		{"title":"beach", "id":10},
		{"title":"game of thrones", "id":11},
		{"title":"nba", "id":12},
		{"title":"easter", "id":13},
		{"title":"anonymous", "id":14},
	];
	$("#srci").tinyAutocomplete({
		data:coversrc,
		onSelect: function(el, val) {
			$(this).val(val.title).focus();
			//$("#srcf").attr('action', '/search/result/'+val.title).submit();
...
var pixiebase = {
	baseUrl: 'https://cdn.jsdelivr.net/gh/szektor78/tlc/imgeditor',
	tools: {
		export: {
			defaultFormat: 'jpeg',
